...
Haematopoietic phylogenies allow the inspection of lifelong clonal dynamics. To this effect, single-cell colonies and were derived and sequenced for three individuals (PD42176, PD34493 and PD41305) and their phylogenetic trees inferred as detailed in \cite{Fabre2021-uw}. For each of these individuals, 85, 93 and 92 sequenced colonies were used to infer each phylogenetic tree. These individuals were selected because they harboured mutations in splicing genes and these phylogenetic trees and subsequent phylodynamic analysis could be used to clarify how these mutations evolved through life and whether they were more likely to expand as age progresses as previously suggested \cite{McKerrell2015-rl}.
...
\begin{figure}[!ht]
	...
	\placecaption{Lifelong clonal trajectories inferred for \cite{Fabre2021-uw} (left) and \cite{Mitchell2021-zl} (right). Fractions of the trajectories showing low variability are represented as full lines, whereas fractions with high variance are represented as dotted lines. A thin grey band represents the carrying capacity from \cite{Lee-Six2018-lp} (Figure 4a,b in \cite{Fabre2021-uw}).}
