...
\begin{figure}[!ht]
    ...
    \label{fig:rbc-aneamia-classification-examples}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \label{fig:wbc-aneamia-classification-examples}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \placecaption{Cross-validated (bars) and external validation \ac{auroc} values for the elastic net regression model.}
    \label{fig:glmnet-auc-validation}
\end{figure}

\begin{figure}[!ht]
    \placefigure{gfx/cytomorphology/mile-vice-auc-validation.pdf}
    \placecaption{Cross-validated (bars) and external validation \ac{auroc} values for \ac{mile-vice}.}
