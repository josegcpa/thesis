...
\subsection{Assessment of the predictive ability of individual morphometric distributions}
...
As mentioned above, \ac{mile-vice} has to assume that cells can be clustered into a given number of virtual cells. I tested three different values for the number of virtual cells in the binary classification tasks (10, 25 and 50) and two different values for the multi-objective task (25 and 50). I also test whether including blood count data can help improve results \figref{fig:mile-vice-performance}. The number of virtual cells has a visible impact on the cross-validation \ac{auroc}:
